        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="entry in entries" :key="entry._id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4">
                <div class="text-sm font-medium" :class="entry.pantry ? 'text-gray-900' : 'text-gray-400'">
                  {{ entry.pantry?.name || 'Inventory' }}
                </div>
              </td>
              <td class="px-6 py-4">
                <div class="text-sm">
              ...
              <td class="px-6 py-4 text-right space-x-2">
                <button
                  ...
                  class="text-indigo-600 hover:text-indigo-900 p-1 rounded hover:bg-indigo-50 inline-flex items-center"
                  title="Edit"
                >
                ...
                <button
                  ...
                  class="text-red-600 hover:text-red-900 p-1 rounded hover:bg-red-50 inline-flex items-center"
                  title="Delete"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
